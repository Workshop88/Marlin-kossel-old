...
#define DELTA_SMOOTH_ROD_OFFSET 221  // mm
...
#define MANUAL_Z_HOME_POS 300.4648  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 88}
